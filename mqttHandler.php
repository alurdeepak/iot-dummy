...
$mqtt = new phpMQTT("10.1.8.15", 1883, "Altf4m2mhandler"); //Change client name to something unique

if(!$mqtt->connect(true,null,"deepak","deepak")){
	exit(1);
}

$topics['altf4mqttmsgs'] = array("qos"=>0, "function"=>"procmsg");
...
//below callback function is called when a msg arrives on the topic
...
$thing_sql=$GET_THING_BY_NAME . $thing_Name1 . "' and t2.utoken='". $utoken. "' and t3.service_name='" . $service_Name1 . "' and t3.transport_id_fk=3";
echo $thing_sql;
